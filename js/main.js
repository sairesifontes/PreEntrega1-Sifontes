...
do{
    ...
    switch(opcion){
        ...
        case "3": 
            ...
            let bak = prompt("Cúantos GB pesa tu información?")
            bak *= bkp 
        ...
        case "4": 
            ...
            let maquinas = prompt("¿En cuántas computadoras lo instalaremos?")
        ...
        case "5": 
            ...
            let nuevaCita = new cita(name, direccion, celular, email)
